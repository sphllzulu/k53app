...
void main() async {
  ...
  print('Note: RLS should be disabled for the questions table for this to work');
  final uuid = Uuid();
  ...
  try {
    ...
    final rulesQuestions = [
      {
        ...
        'learner_code': 1,
        'question_text': 'What does a solid white line across the road indicate?',
        'options': [
        ...
        'correct_index': 1,
        'explanation': 'A solid white line across the road indicates a stop line. You must stop behind this line.',
        'difficulty_level': 1,
      },
      {
        'category': 'rules_of_road',
        ...
        'correct_index': 1,
        'explanation': 'At a roundabout, you must give way to traffic already on the roundabout (approaching from your right).',
        'difficulty_level': 1,
      },
      {
        'category': 'rules_of_road',
        'learner_code': 3,
        'question_text': 'What is the minimum following distance in good conditions?',
        'options': [
          {'text': '1 second'},
          {'text': '2 seconds'},
          {'text': '3 seconds'},
        ...
        'correct_index': 1,
        'explanation': 'The minimum safe following distance in good conditions is 2 seconds.',
        'difficulty_level': 1,
      },
    ];
    ...
    final signsQuestions = [
      {
        'category': 'road_signs',
        'learner_code': 1,
        'question_text': 'What does a red triangle sign with an exclamation mark mean?',
        'options': [
          {'text': 'Danger ahead'},
          {'text': 'No entry'},
          {'text': 'Speed limit'},
        ...
        'correct_index': 0,
        'explanation': 'A red triangle with an exclamation mark is a warning sign indicating potential danger ahead.',
        'difficulty_level': 1,
      },
      {
        'category': 'road_signs',
        'learner_code': 2,
        'question_text': 'What does a blue circular sign with a white arrow pointing left mean?',
        'options': [
          {'text': 'Turn left only'},
          {'text': 'No left turn'},
          {'text': 'Left lane ends'},
        ...
        'correct_index': 0,
        'explanation': 'A blue circular sign with a white arrow indicates a mandatory direction - you must turn left.',
        'difficulty_level': 1,
      },
      {
        'category': 'road_signs',
        ...
        'correct_index': 1,
        'explanation': 'Yellow diamond signs indicate road construction or maintenance ahead.',
        'difficulty_level': 1,
      },
    ];
    ...
    final controlsQuestions = [
      {
        ...
        'correct_index': 0,
        'explanation': 'Before starting a motorcycle, always check fuel level, brakes, tires, and lights.',
        'difficulty_level': 1,
      },
      {
        'category': 'vehicle_controls',
        'learner_code': 2,
        'question_text': 'What does the anti-lock braking system (ABS) prevent?',
        'options': [
      ...
      },
      {
        ...
        'correct_index': 0,
        'explanation': 'A retarder helps slow down heavy vehicles without using the service brakes, reducing brake wear.',
        'difficulty_level': 1,
      },
    ];
    ...
    print('Categories covered: Rules of the Road, Road Signs, Vehicle Controls');
    print('Learner codes: 1 (Motorcycles), 2 (Light Vehicles), 3 (Heavy Vehicles)');
